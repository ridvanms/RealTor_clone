        ...
        <div className="w-full md:w-[67%] lg:w-[40%] lg:ml-20">
          <form>
            ...
            <div className="relative mb-6">
              ...
              autoComplete="off" //trying to remove the second eye in the edge browser
              />
              {showPassword ? (<AiFillEyeInvisible className="absolute right-3 top-3 cursor-pointer text-xl" onClick={() => setShowPassword((prevState)=>!prevState)} />)
          ...
          <button className="w-full bg-blue-600 text-white px-7 py-3 text-sm font-medium uppercase rounded shadow-md hover:bg-blue-700 transition duration-150 ease-in-out hover:shadow-lg" type="submit">Sign In</button>
        </div>
      </div>
    </section>
  );
